...
@section('main')
<!--begin::Form-->
<form class="kt-form row" method="POST" enctype="multipart/form-data" action="{{ route('manager.products.store') }}">
    @csrf
    <div class="col-md-4">
            ...
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        ...
                        value="{{old('barcode')}}" placeholder="Nhập mã vạch">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        ...
                        value="{{old('abv')}}" placeholder="Nhập nồng độ cồn">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        ...
                        value="{{old('vintage')}}" placeholder="Nhập năm sản xuất">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        ...
                        value="{{ old('price') ?? '0'}}" placeholder="Nhập đơn giá">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        ...
                        value="{{old('sale') ?? '0'}}" placeholder="Nhập tỉ lệ giảm giá">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        ...
                        value="{{old('instock') ?? '0'}}" placeholder="Nhập số lượng tồn">
