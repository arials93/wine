...
@section('main')
<!--begin::Form-->
<form class="kt-form row" method="POST" enctype="multipart/form-data" action="{{ route('manager.blogs.update',['blog' => $blog->id]) }}">
    @method('PUT')
    @csrf
    <div class="col-md-4">
            ...
            <div class="kt-portlet__body"> 
                <div class="kt-section kt-section--first">
                    ...
                    <label class="kt-section__body w-100">
                        <img width="100%" src="{{ asset('storage/'.$blog->image) }}" id="review-img"/>
            ...
            <div class="kt-portlet__body">
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        ...
                        value="{{old('name') ? old('name') : $blog->name}}" placeholder="Nhập tên">
                        ...
                        <select class="form-control" name="blog_category_id">
                            @foreach ($blog_categories as $item)
                                <option value="{{$item->id}}" 
                                    {{old('blog_category_id') == $item->id || $item->id == $blog->blog_category_id ? 'selected':'' }}>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12">
                        ...
                        placeholder="Nhập tóm tắt">{{ old('sub_description') ? old('sub_description') :  $blog->sub_description}}</textarea>
