...
@section('main')
<!--begin::Form-->
<form class="kt-form row" method="POST" enctype="multipart/form-data" action="{{ route('manager.others.brands.store') }}">
    @csrf
    <div class="col-md-4">
