                        ...
                        <div class="kt-widget17__items">
                            <div class="kt-widget17__item">
                                ...
                                <span class="kt-widget17__desc">
                                    {{ $new_order }} đơn (<a href="{{route('manager.bills.tab', 'new')}}">Chi tiết</a>)
                                </span>
                            </div>
                            <div class="kt-widget17__item">
                                <span class="kt-widget17__icon">
                                ...
                                <span class="kt-widget17__desc">
                                    {{ $confirmed }} đơn (<a href="{{route('manager.bills.tab', 'confirmed')}}">Chi tiết</a>)
                                </span>
                            </div>
                        </div>
                        <div class="kt-widget17__items">
                            <div class="kt-widget17__item">
                                ...
                                <span class="kt-widget17__desc">
                                    {{ $delivery }} (<a href="{{route('manager.bills.tab', 'delivery')}}">Chi tiết</a>)
                                </span>
                            </div>
                            <div class="kt-widget17__item">
                                <span class="kt-widget17__icon">
                                ...
                                <span class="kt-widget17__desc">
                                    {{ $completed }} đơn (<a href="{{route('manager.bills.tab', 'received')}}">Chi tiết</a>)
                                </span>
                            </div>
                        </div>
                    </div>
